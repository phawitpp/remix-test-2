...
import { Mail } from "~/data/mailData";
    ...
    <div className="flex h-full flex-col bg-neutral-950 text-white">
      ...
      {mail ? (
        <div className="flex flex-1 flex-col">
          ...
          <Separator className="mt-auto bg-neutral-800 text-white" />
          <div className="p-4">
            <form>
              <div className="grid gap-4">
                <Textarea
                  className="p-4 bg-neutral-950 text-white placeholder:text-neutral-600 border-neutral-800"
